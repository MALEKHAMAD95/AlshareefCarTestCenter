...
import {
    CreateSafeDeposit,
    UpdateSafeDeposit,
} from '@/services/ModelSserver/SafeDepositsServices'
import {
...
const SafeDepositsCU = forwardRef(
    (
        {
            onSubmitSuccess,
            onCancel,
        ...
        const onSubmit = async (data) => {
            ...
            try {
                const response = isEditMode
                    ? await UpdateSafeDeposit({
                          ...payload,
                          id: initialData?.id,
                      })
                    : await CreateSafeDeposit(payload)
