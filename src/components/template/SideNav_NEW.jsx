                                ...
                                <>
                                    ...
                                    >
                                        <button
                                            type="button"
                                            className="app-side-bar__nav-link"
                                            onClick={() => toggleCollapseSection(nav.key)}
                                        >
                                            {renderNavLinkContent(nav)}
                                            <TbChevronRight
                                                className={classNames(
                                    ...
                                    >
                                        {nav.subMenu?.map((subNav) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    {t(subNav.translateKey, subNav.title)}
                                                </Link>
                                            </AuthorityCheck>
                                        ))}
                                    </div>
            ...
            <div className="app-side-bar__inner">
                ...
                <div className="app-side-bar__logo-row">
                    ...
                    >
                        ...
                        />
                        <span className="app-side-bar__logo-name">
                            {DEFAULT_COMPANY_NAME}
                        </span>
                    </Link>
                    <button
                        type="button"
                        className="app-side-bar__toggle md:hidden"
                        onClick={() => setSideNavCollapse(!sideNavCollapse)}
                        aria-label={sideNavCollapse ? 'Expand sidebar' : 'Collapse sidebar'}
                    >
                        <TbX />
                    </button>
                </div>
